...
## Database Tables
- `venues` — 41 active venues (44 total, 3 deactivated) with scrape_urls auto-discovered by the multi-strategy engine
- `events` — 402 events across 41 venues (with event_type classification + age_range fields)
...
## Venues Currently in Database (44 total, 41 active)
### Top Venues by Event Count
1. Stone Mountain Park (167 events — strategy: jsonld)
2. Booth Western Art Museum (25 events — strategy: jsonld)
3. Fernbank Museum of Natural History (24 events — strategy: html)
4. Chattahoochee Nature Center (22 events — strategy: jsonld)
5. Zoo Atlanta (19 events — strategy: html)
6. Amicalola Falls State Park (16 events — strategy: jsonld)
7. Tellus Science Museum (16 events — strategy: html)
8. Southern Museum of Civil War and Locomotive History (13 events — strategy: jsonld)
9. City of Alpharetta Events (10 events — strategy: jsonld)
10. Southeastern Railway Museum (10 events — strategy: jsonld)
11. Atlanta Botanical Garden (9 events — strategy: html)
12. North Georgia Zoo (9 events)
13. Lake Lanier Islands (8 events — strategy: jsonld)
14. Scottsdale Farms (8 events — strategy: html)
15. Gibbs Gardens (7 events — strategy: html)
16. Cagle's Family Farm (6 events — strategy: html)
17. Reinhardt University (6 events — strategy: jsonld)
18. Woodstock Arts (5 events — strategy: html)
19. City of Roswell Events (4 events — strategy: html)
20. Lake Lanier Islands (4 events — strategy: apify)
21. Pettit Creek Farms (4 events — strategy: html)
22. Roswell Cultural Arts Center (4 events — strategy: html)
23. Cherokee County Parks & Recreation (3 events — strategy: jsonld)
24. Mercier Orchards (2 events — strategy: html)

### Venues with 0–1 Events (need work)
25. Atlanta History Center (1 — JS-rendered)
26. Canton Farmers Market (1 — JS-rendered)
27. Canton Theatre (1 — JS-rendered, Apify)
28. Center for Puppetry Arts (1 — JS-rendered)
29. Cherokee County Aquatic Center (1 — JS-rendered)
30. City of Roswell Events (1 — JS-rendered)
31. Ellijay Apple Houses (1 — strategy: html)
32. Main Event Alpharetta (1 — strategy: html)
33. Berry Patch Farms (0 — seasonal, closed until fall)
34. Burt's Pumpkin Farm (0 — seasonal, site down until September)
35. City of Woodstock Events (0 — JS-rendered)
36. Copper Creek Farm (0 — 403 blocked)
37. High Museum of Art (0 — JS-rendered)
38. Hot Wheels Skate Center (0 — events are image-only)
39. INK Children's Museum (0 — 403 blocked)
40. Sandy Springs Performing Arts (0 — fetch blocked)
41. Sequoyah Regional Library System (0 — JS-rendered LibCal)
42. The Holler (0 — no structured events, Facebook only)
43. Uncle Shuck's Corn Maze (0 — seasonal, fall only)
